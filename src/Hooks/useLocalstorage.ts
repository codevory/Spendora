import type { CategoryPropsType, IncomeType, TransactionType } from "../types/transactionType";
...
const useLocalstorage = () => {
  ...
  const userCategories = safeParseArray<CategoryPropsType>(localStorage.getItem("userCategories"))
