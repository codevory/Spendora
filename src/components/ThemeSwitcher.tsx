...
const ThemeSwitcher = () => {
  ...
  return (
    ...
    >
      <span
        className={`flex h-6 w-6 items-center justify-center rounded-full text-xs transition-all ${isDark ? "bg-slate-950 text-slate-100" : "bg-yellow-500 text-slate-900"}`}
      >
